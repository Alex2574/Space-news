...
const routes: Routes = [
  ...
  { path: 'news-content', component: NewsContentComponent },
  {
    path: 'news-content',
    children: [
      { path: 'news01', component: News01Component },
      { path: 'news02', component: News02Component },
      { path: 'news03', component: News03Component },
      { path: 'news04', component: News04Component },
      { path: 'news05', component: News05Component },
      { path: 'news06', component: News06Component },
      { path: 'news07', component: News07Component },
      { path: 'news08', component: News08Component },
      { path: 'news09', component: News09Component },
      { path: 'news10', component: News10Component },
    ],
  },
